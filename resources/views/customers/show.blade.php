    ...
    <div class="py-6">
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <!-- Profile Card -->
                <div class="md:col-span-2 bg-gray-900 rounded-[24px] p-8 text-white shadow-xl relative overflow-hidden">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col justify-center items-center text-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                    ...
                    <div class="space-y-4">
                        @foreach($customerData['addresses'] as $address)
                            <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100">
                ...
                <!-- Order History -->
                <div class="lg:col-span-2 bg-white dark:bg-gray-900 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden flex flex-col">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-white">
                                    <th class="p-4 pl-6 border-b border-gray-50 text-[10px] font-black text-gray-400 uppercase tracking-widest">Order ID</th>
                                    <th class="p-4 border-b border-gray-50 text-[10px] font-black text-gray-400 uppercase tracking-widest">Date</th>
                                    <th class="p-4 border-b border-gray-50 text-[10px] font-black text-gray-400 uppercase tracking-widest">Items</th>
                                    <th class="p-4 border-b border-gray-50 text-[10px] font-black text-gray-400 uppercase tracking-widest">Total</th>
                                    <th class="p-4 pr-6 border-b border-gray-50 text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">Status</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-50">
                                @foreach($customerData['orders'] as $order)
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td class="p-4 pl-6 font-black text-gray-900 dark:text-white">#{{ $order->id }}</td>
                                        ...
                                        <td class="p-4 font-black text-gray-900 dark:text-white">Rs.{{ number_format($order->total_amount) }}</td>
                                        <td class="p-4 pr-6 text-right">
                                            ...
                                            @endphp
                                            <span class="text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-md border {{ $color }}">
                                                {{ $order->status }}
                                            </span>
                                        </td>
                                    </tr>
