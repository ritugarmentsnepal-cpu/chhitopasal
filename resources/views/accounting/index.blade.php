<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Horizontal Tab Bar -->
            <div class="mb-6 bg-white dark:bg-gray-900 p-2 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.02)] dark:shadow-none border border-gray-100 dark:border-gray-800 flex overflow-x-auto no-scrollbar gap-1">
                @foreach($tabs as $key => $t)
                    <a href="{{ route('accounting.index', ['tab' => $key]) }}" class="flex items-center gap-1.5 px-4 py-2.5 rounded-full font-bold text-sm whitespace-nowrap transition-all {{ $tab === $key ? 'bg-mango text-gray-900 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
