<x-app-layout>
  ...
  <div class="py-6 min-h-screen" x-data="{ activeTab: 'dashboard' }">
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div x-show="activeTab === 'dashboard'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <!-- Metric Card -->
          <div class="bg-white rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 relative overflow-hidden group">
        ...
        <div class="bg-white rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-0 overflow-hidden" x-data="locationFinder()">
          <!-- Header -->
      ...
      <div x-show="activeTab === 'disputes'" x-cloak x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0">
        <div class="bg-white rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-red-200 overflow-hidden">
    ...
    <!-- Settlement Modal -->
    @include('pathao.partials.settlement_modal')

  </div>

  @include('pathao.partials.scripts')
