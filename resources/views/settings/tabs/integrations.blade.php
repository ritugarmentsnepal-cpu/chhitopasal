<div>
    ...
    <form method="POST" action="{{ route('settings.store') }}" class="mt-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 mt-8">
            ...
            <div class="mb-6">
                <label class="block text-sm font-bold text-gray-700 mb-2">Pixel ID</label>
                <input name="facebook_pixel_id" type="text" value="{{ setting('facebook_pixel_id') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3 font-bold font-mono tracking-wider" placeholder="e.g. 123456789012345" />
                <p class="text-xs text-gray-500 mt-2">
