    ...
    <form method="POST" action="{{ route('settings.store') }}" class="mt-8">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-xl font-black text-gray-900 dark:text-white">Google Tag Manager</h3>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 mt-8">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-xl font-black text-gray-900 dark:text-white">Facebook Pixel</h3>
