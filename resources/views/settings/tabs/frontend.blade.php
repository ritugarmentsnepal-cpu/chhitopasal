<form method="POST" action="{{ route('settings.store') }}" enctype="multipart/form-data">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Store Name</label>
                <input name="store_name" type="text" value="{{ setting('store_name', 'ChhitoPasal') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-900/10 py-3 font-medium transition-colors" />
            </div>
            <div>
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">SEO Meta Description</label>
                <input name="meta_description" type="text" value="{{ setting('meta_description') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-900/10 py-3 font-medium transition-colors" placeholder="E.g. Best online store for electronics..." />
            </div>

            <div class="pt-4 border-t border-gray-100">
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Store Logo (Appears on Navbar)</label>
            ...
            <div class="pt-4 border-t border-gray-100">
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Favicon</label>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Support Email</label>
                <input name="contact_email" type="email" value="{{ setting('contact_email', 'support@chhitopasal.com') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-900/10 py-3 font-medium transition-colors" />
            </div>
            <div>
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Support Phone</label>
                <input name="contact_phone" type="text" value="{{ setting('contact_phone', '+977 9800000000') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-900/10 py-3 font-medium transition-colors" />
            </div>
            <div class="sm:col-span-2">
                <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Store Address</label>
                <input name="contact_address" type="text" value="{{ setting('contact_address', 'Kathmandu, Nepal') }}" class="block w-full rounded-xl border-gray-200 bg-gray-50 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-900/10 py-3 font-medium transition-colors" />
            </div>
        </div>
    </div>
