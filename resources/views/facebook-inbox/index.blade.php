<x-app-layout>
  <div x-data="facebookInbox('{{ $pages->count() > 0 ? $pages->first()->page_id : '' }}')" x-init="init()" class="flex h-[calc(100vh-72px)] bg-white border-t border-gray-100 ">
    
    <!-- Sidebar: Threads & Posts -->
    <div class="w-80 border-r border-gray-100 flex flex-col bg-gray-50 shrink-0">
      <!-- Header & Pages Dropdown -->
      <div class="p-4 border-b border-gray-100 bg-white ">
        <div class="flex items-center justify-between mb-4">
          <h2 class="font-black text-lg text-gray-900 flex items-center gap-2">
