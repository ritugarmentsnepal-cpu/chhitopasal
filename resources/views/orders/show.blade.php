                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        @forelse($order->libraryMockups as $mockup)
                                            <a href="{{ '/storage/' . $mockup->image_path }}" target="_blank" class="aspect-square bg-gray-50 border border-gray-100 rounded-xl overflow-hidden flex items-center justify-center p-1.5 hover:border-indigo-300 transition">
