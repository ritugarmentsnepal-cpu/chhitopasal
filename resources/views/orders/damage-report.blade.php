    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
      <div>
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-2xl font-black text-gray-900 ">Damage Report</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
      <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-2xl font-black text-gray-900 ">{{ $totalDamagedQty }}</p>
      ...
      <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-2xl font-black text-gray-900 ">Rs.{{ number_format($totalDamagedValue) }}</p>
      ...
      <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-2xl font-black text-gray-900 ">{{ $totalDamagedOrders }}</p>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-50 ">
              @foreach($damagedItems as $item)
                <tr class="hover:bg-gray-50/50 transition">
                  <!-- Order -->
                  <td class="px-6 py-4">
                    <div class="text-sm font-black text-gray-900 ">#{{ str_pad($item->order->id, 5, '0', STR_PAD_LEFT) }}</div>
                    <div class="text-xs text-gray-500 mt-0.5">{{ $item->order->customer_name }}</div>
                  </td>
                  <!-- Product -->
                  <td class="px-6 py-4">
                    <div class="text-sm font-bold text-gray-900 ">{{ $item->product->name ?? 'Unknown' }}</div>
      ...
      @else
        <div class="p-16 text-center">
          ...
          <h3 class="text-lg font-black text-gray-900 ">No Damaged Items</h3>
